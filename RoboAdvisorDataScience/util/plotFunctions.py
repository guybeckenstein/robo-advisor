...
def plotGiniGraph(sectorsList, threeBestSectorsWeights, min_variance_port,
                  sharpe_portfolio,
                  max_profolios_annual, max_ginis, df):
...
def plotThreePortfoliosGraph(min_variance_port, sharpe_portfolio, max_returns, threeBestSectorsWeights,
    ...
    pctChangeTable['yield_1'].plot(figsize=figSize, grid=True, color="yellow", linewidth=2, label="saftest",
                                   legend=True, linestyle="dashed")
    pctChangeTable['yield_2'].plot(figsize=figSize, grid=True, color="green", linewidth=2, label="sharpe",
                                   legend=True, linestyle="dashed")
    pctChangeTable['yield_3'].plot(figsize=figSize, grid=True, color="red", linewidth=2, label="max return",
                                   legend=True, linestyle="dashed")
