        ...
        if selection == 1:  # Basic data from user
            ...
            while selection != exit_loop_operation:
                ...
                # plot 3 best portfolios graph
                    ...
                    stocks_collection_repo_dir: str = settings.BASIC_STOCK_COLLECTION_REPOSITORY_DIR
                    closing_prices_table_path = f'{stocks_collection_repo_dir}{stocks_collection_number}/'
