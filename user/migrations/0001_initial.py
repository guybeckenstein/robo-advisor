        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(primary_key=True, serialize=False,
                                           verbose_name='ID')),
                ('risk_level', models.IntegerField(validators=[django.core.validators.MinValueValidator(1),
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.RESTRICT,
